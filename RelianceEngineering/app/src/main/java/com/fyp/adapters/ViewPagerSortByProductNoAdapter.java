...
import com.fyp.fragments.SortBy.PNo;
...
public class ViewPagerSortByProductNoAdapter extends FragmentPagerAdapter {
    ArrayList<TableData> list;
    int tab=0;
    public ViewPagerSortByProductNoAdapter(FragmentManager fm, ArrayList<TableData> list, int tab) {
        super(fm);
        this.list=list;
        this.tab=tab;
    }
    ...
    public Fragment getItem(int position) {
        ...
        if (position == 0) {
            ...
            fragment = new PNo(this.list,tab);
