...
public class ProductFormAdapter extends RecyclerView.Adapter<ProductFormAdapter.ViewHolder> {
    ...
    public ProductFormAdapter(Context context, int value, ArrayList<TableData> data, ItemClickListener mClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_views_5, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txt1.setText(data.getProductForm());
        holder.txt2.setText(data.getSpecNo());
        holder.txt3.setText(data.getTypeGrade());
        holder.txt4.setText(data.getNominalComposition());
