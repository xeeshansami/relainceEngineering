...
public class List1Adapter extends RecyclerView.Adapter<List1Adapter.ViewHolder> {
    ...
    public List1Adapter(Context context, ArrayList<Branch> data,ItemClickListener mClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_views_2, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.img1.setImageResource(data.getBranchLat());
