...
public class SpecificationAdapter extends RecyclerView.Adapter<SpecificationAdapter.ViewHolder> {
    ...
    public SpecificationAdapter(Context context, int value, ArrayList<TableData> data, ItemClickListener mClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_views_3, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txt1.setText(data.getSpecNo());
        holder.txt2.setText(data.getTypeGrade());
        holder.txt3.setText(data.getNominalComposition());
