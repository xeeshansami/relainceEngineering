...
public class PNoAdapter extends RecyclerView.Adapter<PNoAdapter.ViewHolder> {
    ...
    public PNoAdapter(Context context, int value, ArrayList<TableData> data, ItemClickListener mClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_views_7, parent, false);
