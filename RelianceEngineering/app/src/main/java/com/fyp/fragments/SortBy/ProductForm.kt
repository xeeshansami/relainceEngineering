...
import com.fyp.adapters.ProductFormAdapter
import com.fyp.db.MyDB
import com.fyp.models.TableData
import com.fyp.utils.SessionManager
import kotlinx.android.synthetic.main.productform.*


class ProductForm(list: java.util.ArrayList<TableData>, tab: Int) : Fragment(), View.OnClickListener {
    var db: MyDB? = null
    ...
    override fun onCreateView(
        ...
        myView = inflater.inflate(R.layout.productform, container, false)
        return myView
    }
