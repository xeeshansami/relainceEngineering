...
class Submit1 : Fragment(), View.OnClickListener, iOnBackPressed {
    var value = ""
    ...
    fun init() {
        ...
        if (listBranch[0].branchName == "NP") {
            ...
            edittext1.setText("Section I - Not Permitted")
        } else {
            edittext1.isEnabled = true
            edittext1.hint = "Section I : Range "+resources.getString(R.string.special_symbol)+" ${listBranch.get(0).branchName}"
        }
        ...
        when (v!!.id) {
            R.id.submitBtn -> {
                if (validation()) {
                    ...
                    intent.putExtra("Temperature", listBranch.get(0).branchName)
    ...
    private fun validation(): Boolean {
        return when {
            !edittext1.text.toString()
                .isNullOrEmpty() && listBranch[0].branchName != "NP" && edittext1.text.toString()
                .toDouble() > listBranch[0].branchName.toDouble() -> {
