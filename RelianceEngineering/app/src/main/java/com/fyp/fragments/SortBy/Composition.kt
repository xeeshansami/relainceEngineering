...
import com.fyp.adapters.CompositionAdapter
import com.fyp.db.MyDB
import com.fyp.models.TableData
import com.fyp.utils.SessionManager
import kotlinx.android.synthetic.main.composition.*


class Composition(list: java.util.ArrayList<TableData>, tab: Int) : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        myView = inflater.inflate(R.layout.composition, container, false)
        return myView
    }
